...
declare function setupRevTables(): any;
...
export class VersionRedRevisionComponent implements OnInit  {
  ...
  getRecursos(): void {
    this.versionService.getRecursos(this.idVersion).subscribe(recursos => (this.recursos = recursos), error=>console.log("error: "+error), ()=>setTimeout(function() { setupRevTables() }, 1000));
  }
